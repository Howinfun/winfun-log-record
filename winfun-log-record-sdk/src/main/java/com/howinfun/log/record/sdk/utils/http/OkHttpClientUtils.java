...
import com.howinfun.log.record.sdk.utils.FastThreadLocalContext;
import com.howinfun.log.record.sdk.utils.json.JsonUtil;
...
public abstract class OkHttpClientUtils {
     ...
     * @throws IOException
     */
    public static <T> T parsePost(@NonNull String url, @NonNull Class<T> classOfT) throws IOException {
        return messageConvertor.deserialize(postReturnBody(url), classOfT);
    }

    public static <T> T parsePost(@NonNull String url, @NonNull Type type) throws IOException {
     ...
     * @throws IOException
     */
    public static <T> T parsePost(@NonNull String url, @NonNull Object object, @NonNull Class<T> classOfT) throws IOException {
        return messageConvertor.deserialize(postReturnBody(url, object), classOfT);
    }

    public static <T> T parsePost(@NonNull String url, @NonNull Object object, @NonNull Type type) throws IOException {
     ...
     * @throws IOException
     */
    public static <T> T parsePost(@NonNull String url, @NonNull Map<String, String> form, @NonNull Class<T> classOfT) throws IOException {
        return messageConvertor.deserialize(postReturnBody(url, form), classOfT);
    }

    public static <T> T parsePost(@NonNull String url, @NonNull Map<String, String> form, @NonNull Type type) throws IOException {
     ...
     * @throws IOException
     */
    public static <T> T parsePost(@NonNull String url, @NonNull Headers headers, @NonNull RequestBody requestBody, @NonNull Class<T> classOfT) throws IOException {
        return messageConvertor.deserialize(postReturnBody(url, headers, requestBody), classOfT);
    }

    public static <T> T parsePost(@NonNull String url, @NonNull Headers headers, @NonNull RequestBody requestBody, @NonNull Type type) throws IOException {
     ...
     * @return
     */
    public static String postReturnBody(@NonNull String url, @NonNull Object object) throws IOException {
     ...
     * @throws IOException
     */
    public static String postReturnBody(@NonNull String url, Headers headers,
     ...
     * @throws IOException
     */
    public static Response post(@NonNull String url, @NonNull Object object) throws IOException {
     ...
     * @throws IOException
     */
    public static Response delete(@NonNull String url) throws IOException {
     ...
     * @throws IOException
     */
    public static Response delete(@NonNull String url, @NonNull Object object) throws IOException {
        String json = messageConvertor.serialize(object);
        RequestBody body = RequestBody.create(json, JSON_TYPE_UTF8);
     ...
     * @throws IOException
     */
    public static Response delete(@NonNull String url, Headers headers, RequestBody body) throws IOException{
        //这里获取url数据
        HttpUrl.Builder httpUrlBuilder = HttpUrl.parse(url).newBuilder();
     ...
     **/
    public static Response post(Request request, @NonNull String url, int retryNum) throws IOException {
     ...
     * @return {@link T }
     **/
    public static <T> T parseGet(@NonNull String url, @NonNull Class<T> classOfT) throws IOException {
        return messageConvertor.deserialize(getReturnBody(url), classOfT);
    }

    public static <T> T parseGet(@NonNull String url, @NonNull Type type) throws IOException {
     ...
     * @throws IOException
     */
    public static <T> T parseGet(@NonNull String url, @NonNull Headers headers, @NonNull Class<T> classOfT) throws IOException {
        return messageConvertor.deserialize(getReturnBody(url, headers), classOfT);
    }

    public static <T> T parseGet(@NonNull String url, @NonNull Headers headers, @NonNull Type type) throws IOException {
     ...
     * @throws IOException
     */
    public static <T> T parseGet(@NonNull String url, @NonNull Map<String, String> params, @NonNull Class<T> classOfT) throws IOException {
        return messageConvertor.deserialize(getReturnBody(url, params), classOfT);
    }

    public static <T> T parseGet(@NonNull String url, @NonNull Map<String, String> params, @NonNull Type type) throws IOException {
     ...
     * @throws IOException
     */
    public static <T> T parseGet(@NonNull String url, @NonNull Headers headers, @NonNull Map<String, String> params, @NonNull Class<T> classOfT) throws IOException {
        return messageConvertor.deserialize(getReturnBody(url, headers, params), classOfT);
    }

    public static <T> T parseGet(@NonNull String url, @NonNull Headers headers, @NonNull Map<String, String> params, @NonNull Type type) throws IOException {
     ...
     * @throws Exception
     */
    public static Call asyncPost(@NonNull String url, Object object, Headers headers, Callback callback) {
        String json = messageConvertor.serialize(object);
